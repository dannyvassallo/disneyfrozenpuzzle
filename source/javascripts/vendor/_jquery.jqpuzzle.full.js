...
$(document).ready(function() {
  ...
  var puzHeight = $('.jqp-wrapper:first-child').height();
  var puzWidth = $('.jqp-wrapper:first-child').width();
  $('#overlay').css({'height': puzHeight, 'width': puzWidth});
}
...
$.when($('.jqp-piece').is(':visible') == true ).then(function(){
  overlayResize();
});
	});
});
